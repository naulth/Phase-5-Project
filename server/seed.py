...
if __name__ == '__main__':
    with app.app_context():
        ...
        g2 = Game(title = "The Witcher 3: Wild Hunt", image = "https://image.api.playstation.com/vulcan/ap/rnd/202211/0711/kh4MUIuMmHlktOHar3lVl6rY.png", genre = "RPG", platform ="PC", price = 59.99)
